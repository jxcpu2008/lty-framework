	...
	<form id="admin_cdglAdd_addForm" method="post">
		<table class="tableForm">
			...
			<tr>
				...
				<th>上级菜单</th>
				<td><input id="admin_cdglAdd_pid" name="pid" class="easyui-combotree" data-options="url:'${pageContext.request.contextPath}/menu/findAllTreeNode.shtml',method:'get',parentField : 'pid',lines : true" style="width:140px;" /><img src="${pageContext.request.contextPath}/style/images/extjs_icons/cut_red.png" onclick="$('#admin_cdglAdd_pid').combotree('clear');" />
				</td>
			</tr>
		</table>
	</form>
